...
const Hero: React.FC = () => {
  return (
    <section id={SectionId.HOME} className="relative min-h-screen flex flex-col justify-center pt-20 overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff_1px,transparent_1px),linear-gradient(to_bottom,#ffffff_1px,transparent_1px)] bg-[size:4rem_4rem] opacity-[0.03] pointer-events-none"></div>
      ...
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-surface/20 rounded-full blur-[100px] translate-y-1/3 -translate-x-1/4 pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col items-start text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-surface/50 border border-white/10 backdrop-blur-sm mb-8 animate-fade-in-up">
              <span className="w-2 h-2 rounded-full bg-accent animate-pulse"></span>
              <span className="text-xs font-bold tracking-wide text-secondary uppercase">Notaría 103 Toluca</span>
            </div>

            <h1 className="text-5xl md:text-7xl font-black text-white tracking-tight leading-[1.1] mb-8 animate-fade-in-up delay-100">
              Certeza Jurídica, <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-secondary">Confianza Absoluta.</span>
            </h1>

            <p className="text-lg text-secondary max-w-xl leading-relaxed mb-10 animate-fade-in-up delay-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full animate-fade-in-up delay-300">
              <button
                ...
                className="bg-accent text-background px-8 py-4 rounded-full font-bold text-lg hover:bg-accent/90 transition-all hover:shadow-glow hover:-translate-y-1 flex items-center justify-center gap-2 group"
              >
                Agendar Cita
              ...
              <button
                ...
                className="bg-surface/50 text-white border border-white/5 px-8 py-4 rounded-full font-bold text-lg hover:bg-surface hover:border-white/20 transition-all hover:-translate-y-1 backdrop-blur-sm"
              >
                Ver Servicios
              </button>
            </div>
