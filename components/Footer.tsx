...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#0a0a0a] text-white pt-24 pb-12 rounded-t-[3rem] mt-12 border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Agendar Cita</a></li>
            </ul>
          </div>
